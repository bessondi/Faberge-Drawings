...
import styles from './lastEggsSlideStyles.module.css';
import img from '../../../../media/images/compressed/romanov_eggs.jpg';
import repeatBtn from '../../../../media/icons/repeatBtn.svg';
import {LastSlideData} from "../../sliderData";



class LastEggsSlide extends Component {
    constructor(props) {
        super(props)
        this.state = {
